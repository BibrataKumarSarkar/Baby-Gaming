    ...
    var _ISM = _R.is_mobile(),
        ...
        runSlider = function(e, t) {
            ...
            if (t.shadow !== undefined && t.shadow > 0 && (e.parent().addClass("tp-shadow" + t.shadow), e.parent().append('<div class="tp-shadowcover"></div>'), e.parent().find(".tp-shadowcover").css({
                ...
                var m = t.viewPort;
                t.inviewport = !1, m != undefined && m.enable && (jQuery.isNumeric(m.visible_area) || -1 !== m.visible_area.indexOf("%") && (m.visible_area = parseInt(m.visible_area, 10) / 100), _R.scrollTicker && _R.scrollTicker(t, e)), setTimeout(function() {
